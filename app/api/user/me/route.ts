...
export async function PATCH(req: NextRequest) {
  ...
  const body = await req.json() as { slack_display_name?: string; model_preferences?: Record<string, string>; hubspot_owner_id?: string | null; email_signature?: Partial<EmailSignature> | null };
  ...
  if ("email_signature" in body) update.email_signature = body.email_signature ? normalizeSignature(body.email_signature) : null;
